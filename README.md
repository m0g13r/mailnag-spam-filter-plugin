🛡️ Advanced Spam Filter for Mailnag (v4.0)
...
🚀 Features
    ...
    ⚖️ Fully Granular Scoring: Every detection category has its own adjustable weight. Fine-tune exactly how many "Spam Points" a match is worth.

    🎯 Adjustable Global Threshold: Set the total score required to filter an email. Allows for anything from aggressive filtering to a "safety net" approach.
    ...
    🧹 Automated Hygiene: Upon saving, all lists are trimmed, deduplicated, and sorted alphabetically to keep your configuration clean.
...
💡 Example Strategy
    ...
    Aggressive: Set Threshold to 10 and TLD Weight to 10 to block suspicious TLDs instantly.

    Balanced: Set Threshold to 5 and Keyword Weight to 1 to require multiple keyword matches before a mail is flagged.
...
🛠️ Installation
    ...
    Configure your custom weights, threshold, and patterns in the plugin settings tab.Advanced Spam Filter for Mailnag (v4.0)
