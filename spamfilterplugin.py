...
class SpamfilterPlugin(Plugin):
    ...
    def load_ui_from_config(self, ui):
        ...
        if preset_combo:
            ...
            if (t, tr, kw, rx, tl) == (3, 2, 3, 4, 6): preset_combo.set_active_id("high")
            elif (t, tr, kw, rx, tl) == (5, 4, 2, 3, 5): preset_combo.set_active_id("medium")
            elif (t, tr, kw, rx, tl) == (8, 5, 1, 2, 3): preset_combo.set_active_id("low")
            else: preset_combo.set_active_id("custom")
        self._preset_changing = False
    ...
    def _is_filtered(self, mail):
        ...
        name = self._decode_header(sender[0] or '').lower()
        ...
        # PRIORITY 2: Keyword scoring (Subject weighted heavily)
